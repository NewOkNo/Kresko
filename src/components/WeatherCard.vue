<template>
    <div @load="myFunction">
        ...
        <div class="card" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
          <div class="search">
          ...
          <div class="weather">
            <h2 class="city">Weather in Tallinn</h2>
            <h1 class="temp">2.11°C</h1>
            <div class="flex">
              <img src="https://openweathermap.org/img/wn/04n.png" alt="" class="icon">
              <div class="description">overcast clouds</div>
            </div>
            <div class="other">
              <div class="humidity">Humidity: 84%</div>
              <div class="wind">Wind Speed: 4.63 km/h</div>
            </div>
          </div>
...
//Vue.loadScript('./vanilla-tilt.js')
<script>
